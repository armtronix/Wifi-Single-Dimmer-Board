...
// -- Project -------------------------------------
#define PROJECT                "Armtronix"          // PROJECT is used as the default topic delimiter
...
#define FRIENDLY_NAME          "ARMtronix"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
#define USE_ARMTRONIX_SINGLE_DIMMER
